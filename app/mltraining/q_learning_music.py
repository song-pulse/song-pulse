def main():
    ...
    states = [0, 1, 2]  # 3 different stress states: 0 means below baseline stress, 1 baseline stress, 2 above
    # baseline stress
    ...
    # TODO: for simplicity just take one of the two parameters and fix timesteps at which we get the data
    # TODO: 2) set parameters (alpha, gamma, ...)
    # TODO: 3) define stateset, actionset, transitionfunction etc.
    # TODO: 3) define update steps for actions, policy etc (as we have to build a new env, not like in gym)
    # TODO: 4) run q learning for normal data
    # TODO 5) run q learning for feedback
